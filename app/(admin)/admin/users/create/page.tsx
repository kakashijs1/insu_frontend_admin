    ...
    <div className="max-w-3xl mx-auto space-y-6">
      <div className="flex items-center gap-4 border-b border-slate-100 pb-6">
        ...
        <div>
          ...
          <p className="text-slate-500 text-sm">
            กำหนดสิทธิ์การเข้าถึงข้อมูลของเจ้าหน้าที่ภายใน
          </p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-[2rem] border border-slate-200 shadow-sm p-8 space-y-8">
        ...
        <div className="space-y-4 font-sans">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {[
              ...
              <label
                key={i}
                className="flex items-center gap-3 p-4 bg-slate-50 rounded-2xl cursor-pointer hover:bg-teal-50 transition-colors group"
              >
        ...
        <div className="pt-4 flex gap-3">
          <button className="flex-1 py-4 bg-slate-900 text-white rounded-2xl font-bold hover:shadow-xl transition-all">
            บันทึกการเปลี่ยนแปลง
          </button>
          <button className="px-6 py-4 border border-slate-200 text-slate-400 rounded-2xl font-bold hover:bg-danger-light hover:text-danger transition-all">
            ยกเลิก
          </button>
        </div>
      </div>
