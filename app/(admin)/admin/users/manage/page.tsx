    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-4">
          <Link
            href="/admin"
            className="p-2 bg-white border border-slate-200 rounded-xl text-slate-400 hover:text-teal-600 transition-all"
          >
            <ArrowLeft size={20} />
          </Link>
          <div>
            <h1 className="text-2xl font-bold text-slate-900">
              จัดการ User เจ้าหน้าที่
            </h1>
            <p className="text-sm text-slate-500">
              ตรวจสอบและตั้งค่าสิทธิ์การเข้าถึงของทีมงานหลังบ้าน
            </p>
          </div>
        </div>
        <Link
      ...
      <div className="bg-white rounded-[2.5rem] border border-slate-200 shadow-sm overflow-hidden">
                ...
                >
                  ...
                  <td className="px-6 py-5">
                    <div className="flex justify-center">
                      <span
                        className={`flex items-center gap-1.5 px-3 py-1 rounded-lg text-[11px] font-bold uppercase tracking-wider ${
                          user.role === "Super Admin"
                            ? "bg-info-light text-secondary border border-secondary/20"
                  ...
                  <td className="px-8 py-5 text-right">
                    <div className="flex justify-end gap-2">
                      ...
                      <button className="p-2 text-slate-400 hover:bg-white hover:text-danger hover:shadow-sm rounded-xl transition-all border border-transparent hover:border-danger-light">
                        <Trash2 size={18} />
                      </button>
                    </div>
                  </td>
        ...
        <div className="px-8 py-4 bg-slate-50/50 border-t border-slate-100 flex items-center justify-between text-xs text-slate-500 font-medium">
          ...
          <div className="flex gap-2">
            <button className="px-3 py-1 bg-white border border-slate-200 rounded-lg hover:bg-slate-50 transition-colors disabled:opacity-50">
              ก่อนหน้า
            </button>
